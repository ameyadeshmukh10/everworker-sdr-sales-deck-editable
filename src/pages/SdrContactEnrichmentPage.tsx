  ...
  return (
    <section className="px-6 lg:px-8 py-20 sm:py-28 lg:py-32">
      <div className="max-w-6xl 2xl:max-w-7xl mx-auto">
        ...
        >
          The data ops your SDRs were doing, now always on.
          <br />
          Data Providers <ArrowRight className="inline h-5 w-5 align-[-2px] mx-1 text-foreground/60" /> A Better CRM
        </motion.p>
        ...
        >
          <QuoteImageCard
            ...
            overlayTitle="Your ideal customers"
            caption="There's a big market out there waiting to discover your brand."
          />
          <QuoteImageCard
            image={womanRightContactEnrich}
            alt="Seller in conversation"
            overlayTitle="Your sellers, reaching more"
            caption="Let AI monitor activity and bring in your people, at the right time."
          />
...
const SdrContactEnrichmentPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-28 pb-12 sm:pt-36 sm:pb-16 lg:pt-44 lg:pb-24 px-6 lg:px-8 overflow-hidden bg-background">
        <div className="max-w-5xl mx-auto w-full text-center">
          ...
          >
            SDR AI Worker · Contact Enrichment
          </motion.p>
          <motion.h1
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <span className="text-foreground">Find (and engage with)</span>
            <br />
            <span className="text-foreground">more of your ideal leads.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            The SDR AI Worker maps the companies that look like your best customers, identifies the buyer group
            inside each one, and keeps phones and emails current as people change jobs. Your team only steps in
            when an account is showing real buying behavior.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="px-6 lg:px-8 pt-16 pb-12 sm:pt-24 sm:pb-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Complete data on every contact.
            <br />
            <span className="hero-gradient-text">Every field filled, kept current automatically.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
          ...
          >
            Most CRMs have a buyer group sketched in and the rest left blank. The SDR AI Worker connects to your
            data providers, fills every missing field on every key contact, and rechecks each record on a
            cadence.{" "}
            <strong className="font-semibold text-foreground">
              Accurate data on every contact in your CRM, by default.
            </strong>
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-6 lg:px-8 pt-10 pb-12 sm:pt-16 sm:pb-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Cover your full ICP.
            <br />
            <span className="hero-gradient-text">Outbound that reaches your real market, not just your CRM.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            className="text-base sm:text-lg text-muted-foreground leading-relaxed"
          >
            Your addressable market is bigger than the working set in your CRM. The SDR AI Worker researches your
            ICP, finds the companies you should already know, and writes them in with the right buyer group
            attached.{" "}
            <strong className="font-semibold text-foreground">
              A real outbound foundation, not a freshly imported list.
            </strong>
          </motion.p>
        </div>
      </section>
      ...
      <section className="px-6 lg:px-8 pt-10 pb-12 sm:pt-16 sm:pb-16">
        <div className="max-w-3xl mx-auto text-center">
          <motion.h2
            ...
            className="text-3xl sm:text-5xl 2xl:text-6xl font-bold tracking-tight text-foreground mb-4 sm:mb-5"
          >
            Prioritize signal, not noise.
            <br />
            <span className="hero-gradient-text">Buyer groups, sequenced the moment an account moves.</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            className="text-base sm:text-lg text-muted-foreground leading-relaxed"
          >
            Your team can't watch every account every day or pull a fresh buyer group on demand. The SDR AI Worker
            watches the signals your target accounts are throwing off and queues the right sequence for the right
            role.{" "}
            <strong className="font-semibold text-foreground">
              Wake up to a prioritized list of accounts in market right now.
            </strong>
          </motion.p>
        </div>
      </section>
...
export default SdrContactEnrichmentPage;
