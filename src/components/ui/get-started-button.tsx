...
export function GetStartedButton({ children = "Book a demo" }: { children?: React.ReactNode }) {
  return (
    <Button onClick={openBookDemo} className="group relative overflow-hidden bg-foreground text-background hover:bg-foreground/90 rounded-[4px]" size="lg">
